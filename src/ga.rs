use rand::Rng;
use rayon::prelude::*;
use crate::{Brain, SPARSITY_HIDDEN_OUTPUT, SPARSITY_INPUT_HIDDEN, SimulationWorld};
...
pub fn train_stand_upright(population_size: usize, top_k: usize, generations: usize, output_path: &str) {
    ...
    for gen in 0..generations {
        ...
        println!("generation {gen}: best_score = {best_score}");
